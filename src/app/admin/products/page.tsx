                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    <thead>
                        <tr style={{ background: '#f8f9fa', borderBottom: '1px solid #eee' }}>
                            <th style={{ padding: '1.2rem 2rem' }}>{t.th_product}</th>
                            <th style={{ padding: '1.2rem 2rem' }}>{t.th_category}</th>
                            <th style={{ padding: '1.2rem 2rem' }}>{t.th_price}</th>
                            <th style={{ padding: '1.2rem 2rem' }}>{t.th_stock}</th>
                            <th style={{ padding: '1.2rem 2rem' }}>{t.th_status}</th>
                            <th style={{ padding: '1.2rem 2rem' }}>{t.th_actions}</th>
                        </tr>
                    </thead>
                    <tbody>
                        {products.map((p) => (
