        ...
        return (
            <div style={pageStyle}>
                <div style={{ ...cardStyle, textAlign: 'center', padding: '4rem 3rem' }}>
                    ...
                    <h2 style={{ fontSize: '1.8rem', fontWeight: 800, marginBottom: '0.5rem' }}>{t.step_done_title}</h2>
                    <p style={{ color: '#888' }}>{t.step_done_desc}</p>
                </div>
            </div>
        )
    }
        ...
        <div style={pageStyle}>
            <div style={cardStyle}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <h1 style={{ fontSize: '2rem', fontWeight: 900, marginBottom: '0.4rem', color: '#1a1a1a' }}>{t.register_title}</h1>
                    <p style={{ color: '#888', fontSize: '0.95rem' }}>{t.register_desc}</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={groupStyle}>
                        ...
                        <div style={inputWrapStyle}>
                            ...
                            <input name="name" type="text" required placeholder={t.full_name_placeholder} style={inputStyle} />
                        </div>
                    </div>
                    ...
                    <div style={groupStyle}>
                        ...
                        <div style={inputWrapStyle}>
                            ...
                            <input name="email" type="email" required placeholder={t.email_placeholder} style={inputStyle} />
                        </div>
                    </div>

                    {/* Phone */}
                    <div style={groupStyle}>
                        <label style={labelStyle}>{t.phone} <span style={{ color: '#bbb', fontWeight: 400 }}>(opsional)</span></label>
                        <div style={inputWrapStyle}>
                            <Phone size={16} style={iconStyle} />
                            <input name="phone" type="tel" placeholder={t.phone_placeholder} style={inputStyle} />
                        </div>
                    </div>
                    ...
                    <div style={groupStyle}>
                        ...
                        <div style={inputWrapStyle}>
                            ...
                            <input name="password" type={showPw ? 'text' : 'password'} required placeholder={t.password_placeholder} style={{ ...inputStyle, paddingRight: '3rem' }} minLength={8} />
                    ...
                    <div style={{ background: '#fff9fb', border: '1px solid #ffe0ef', borderRadius: '12px', padding: '1rem 1.25rem', marginBottom: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <p style={{ fontSize: '0.8rem', fontWeight: 800, color: '#FF69B4', margin: '0 0 0.2rem' }}>{t.benefits_title}</p>
                        {[
                            { icon: <ShoppingBag size={14} />, text: t.benefit_history },
                            { icon: <Star size={14} />, text: t.benefit_checkout },
                            { icon: <Sparkles size={14} />, text: t.benefit_promo },
                        ].map((b, i) => (
                    ...
                    >
                        {loading ? t.btn_processing : <><span>{t.btn_register}</span><ArrowRight size={20} /></>}
                    </button>
                </form>

                <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.9rem', color: '#888' }}>
                    {t.has_account}{' '}
                    <Link href={`${prefix}/login`} style={{ color: '#FF69B4', fontWeight: 700, textDecoration: 'none' }}>
                        {t.login_now}
                    </Link>
                </p>
            </div>
