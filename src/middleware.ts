...
const RESERVED_PATHS = ['admin', 'super-admin', 'api', 'login', 'register', '_next', 'profile', 'cart', 'checkout', 'favicon.ico', 'product', 'products', 'order', 'about', 'pricing', 'onboarding', 'terms', 'privacy', 'help'];
